...
const bitcount = Bitcount_Prop_Single({ subsets: ["latin"], variable: "--font-bitcount", display: "swap", weight: "variable", adjustFontFallback: false });
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en" className={`${geist.variable} ${oswald.variable} ${bitcount.variable}`}><body><a className="skip-link" href="#main">Skip to content</a><GrainOverlay /><Navbar /><main id="main">{children}</main><Footer /></body></html>; }
